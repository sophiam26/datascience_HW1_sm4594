...
```
    ...
    ## [1] 0.42420913 0.05768983 0.00000000 0.19201338 0.67539548 0.23373436
    ## [7] 0.00000000 0.54340366
...
```
    ...
    ## [1]  0.8484183  0.1153797 -0.9360729  0.3840268  1.3507910  0.4674687
    ## [7] -0.4616475  1.0868073
...
standard deviation of x are 0.0266403, 0.0486705 and 1.0010126,
respectively.*
...
\#\# Making a scatterplot of y vs. x; color points using factor
variable
